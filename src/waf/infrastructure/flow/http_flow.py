"""Adapter: HttpRequest (WAF L7 unit) -> Flow observation unit.

Serializes the request to bytes the way it would appear on the wire and derives
the flow metadata used by content and sequence models.
"""
